 <div  class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500 hover:shadow">
                ...
                @foreach($todos as $todo)
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button wire:click="destroy({{ $todo['id'] }})" wire:confirm="Are you sure you want to delete" class="text-sm text-red-500 font-semibold rounded hover:text-teal-800 mr-1">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round"
